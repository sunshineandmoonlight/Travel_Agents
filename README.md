...
- **前端地址**: http://106.53.173.173:4000
- **后端API**: http://106.53.173.173:8005
- **API文档**: http://106.53.173.173:8005/docs

**注意**: 服务器为演示环境，可能存在不稳定情况，建议本地部署以获得最佳体验。

### 快速体验

1. 访问 http://106.53.173.173:4000
2. 选择旅行范围（国内/国际）
3. 填写旅行需求（天数、预算、兴趣等）
4. 查看AI推荐的目的地
5. 选择旅行风格（沉浸式/探索式/休闲式/小众）
6. 等待2-3分钟，获取完整攻略
